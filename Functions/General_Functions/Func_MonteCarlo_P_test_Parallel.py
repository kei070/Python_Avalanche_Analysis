...
# permutation test
def perm_test(args):
        combined_samples, n1, observed_statistic = args
...
def monte_carlo_pp(sample_ai, sample_bi, num_permutations=500000, switch=True):
    ...
    obs_stat = test_statistic(sample_a, sample_b)
    ...
    with concurrent.futures.ProcessPoolExecutor() as executor:
        # Generate random samples and submit tasks
        futures = [executor.submit(perm_test, (combined_samples, n1, obs_stat)) for _ in range(num_permutations)]
