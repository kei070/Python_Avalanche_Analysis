...
out_df.to_csv(out_path + "LR_Single_Feature_Accuracy.csv")


#%% also store the other model metrics
fid_train_m.to_csv(out_path + "LR_Single_Feature_Metrics_Train.csv")
fid_test_m.to_csv(out_path + "LR_Single_Feature_Metrics_Test.csv")
fid_test_all_m.to_csv(out_path + "LR_Single_Feature_Metrics_Test_All.csv")
fid_train_s.to_csv(out_path + "LR_Single_Feature_Metrics_Std_Train.csv")
fid_test_s.to_csv(out_path + "LR_Single_Feature_Metrics_Std_Test.csv")
fid_test_all_s.to_csv(out_path + "LR_Single_Feature_Metrics_Std_Test_All.csv")
