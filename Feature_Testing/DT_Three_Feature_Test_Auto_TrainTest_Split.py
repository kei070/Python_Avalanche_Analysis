...
out_df.to_csv(out_path + f"DT_Three_Feature_Accuracy-{feat1}-{feat2}.csv")


#%% also store the other model metrics
fid_train_m.to_csv(out_path + f"DT_Three_Feature_Metrics_Train-{feat1}-{feat2}.csv")
fid_test_m.to_csv(out_path + f"DT_Three_Feature_Metrics_Test-{feat1}-{feat2}.csv")
fid_test_all_m.to_csv(out_path + f"DT_Three_Feature_Metrics_Test_All-{feat1}-{feat2}.csv")
fid_train_s.to_csv(out_path + f"DT_Three_Feature_Metrics_Std_Train-{feat1}-{feat2}.csv")
fid_test_s.to_csv(out_path + f"DT_Three_Feature_Metrics_Std_Test-{feat1}-{feat2}.csv")
fid_test_all_s.to_csv(out_path + f"DT_Three_Feature_Metrics_Std_Test_All-{feat1}-{feat2}.csv")
