...
out_df.to_csv(out_path + f"LR_Two_Feature_Accuracy-{first_feat}.csv")


#%% also store the other model metrics
fid_train_m.to_csv(out_path + f"LR_Two_Feature_Metrics_Train-{first_feat}.csv")
fid_test_m.to_csv(out_path + f"LR_Two_Feature_Metrics_Test-{first_feat}.csv")
fid_test_all_m.to_csv(out_path + f"LR_Two_Feature_Metrics_Test_All-{first_feat}.csv")
fid_train_s.to_csv(out_path + f"LR_Two_Feature_Metrics_Std_Train-{first_feat}.csv")
fid_test_s.to_csv(out_path + f"LR_Two_Feature_Metrics_Std_Test-{first_feat}.csv")
fid_test_all_s.to_csv(out_path + f"LR_Two_Feature_Metrics_Std_Test_All-{first_feat}.csv")
